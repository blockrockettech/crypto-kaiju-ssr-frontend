          ...
          <div class="form-group row">
            ...
            <div class="col-sm-10">
              <select class="form-control"
                ...
                <option v-for="gender in formLookupData.gender" :value="gender" :key="gender.name">{{gender.name}}</option>
              </select>
            </div>
          </div>
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-10">
              <select class="form-control"
                ...
                <option v-for="colour in formLookupData.colour" :value="colour" :key="colour.name">{{colour.name}}</option>
              </select>
            </div>
          </div>
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-10">
              <select class="form-control"
                ...
                <option v-for="batch in formLookupData.batch" :value="batch" :key="batch">{{batch}}</option>
              </select>
            </div>
          </div>
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-10">
              <select class="form-control"
                ...
                <option v-for="kclass in formLookupData.kclass" :value="kclass" :key="kclass">{{kclass}}</option>
              </select>
            </div>
          </div>
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-10">
              <select class="form-control"
                ...
                <option v-for="skill in formLookupData.skills" :value="skill" :key="skill">{{skill}}</option>
              </select>
            </div>
          </div>
