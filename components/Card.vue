    ...
    >
      <div class="text-left">
        <div class="row mb-2">
          ...
          <div class="col">
            <span class="small">Owner</span><br/><code>
            <clickable-address :eth-address="cdata.owner"></clickable-address>
          </code>
          </div>
        </div>
        <div class="row mb-2">
        ...
        <div class="row mb-2">
          <div class="col text-center">
            <nuxt-link :to="{ name: 'token-id', params: { id: cdata.tokenId }}" class="btn-link text-info">
              More details
            </nuxt-link>
          </div>
        </div>
